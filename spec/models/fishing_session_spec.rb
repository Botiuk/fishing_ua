...
RSpec.describe FishingSession, type: :model do
  describe "validations" do
    ...
    it "is not valid without a start_at" do
      ...
      expect(fishing_session).to_not be_valid
    end
    ...
    it "is not valid when start_at greater than end_at" do
      ...
      fishing_session = build(:fishing_session, start_at: time_now, end_at: (time_now - 1.minutes))
      expect(fishing_session).to_not be_valid
    end
